...
public enum ChallengeValidationResultType
{
    /// <summary>
    /// This value is used when the Challenge identifier was never loaded
    /// into the expected output cache.
    /// </summary>
    NoExpectedResultEntry,

    /// <summary>
    /// This value is used when the Challenge identifier was found in the
